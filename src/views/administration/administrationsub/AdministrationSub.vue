<template>
  <div
    class="right-list"
    v-for="item in loginStore.admindemo"
    :key="item.iid"
...
function feachPage(formData: any = {}) {
  ...
  console.log(searchInfo, '0000')
  // 2.发起网络请求
  loginStore.adminResultAction(searchInfo)
}
...
// console.log(iid, '这是route获取的id')

function bounceToDetail(iid: number) {
  // console.log(iid, '点击了的列表iid')
